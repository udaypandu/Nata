 ...
 */
public class PrivateForumFragment extends Fragment implements IAsyncCaller, View.OnClickListener, AbsListView.OnScrollListener, IUpdateNewData {

    public static final String TAG = "PrivateForumFragment";
    ...
    private void getPrivateForums(String pageNo) {
        ...
        ServerIntractorAsync serverIntractorAsync = new ServerIntractorAsync(getActivity(), Utility.getResourcesString(getActivity(),
                ...
                APIConstants.PRIVATE_TOPICS_FORUM + ForumTabDetailFragment.forumModel.getId() + "/" + pageNo + "/20"
                , paramMap,
