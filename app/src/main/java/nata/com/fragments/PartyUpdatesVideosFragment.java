...
public class PartyUpdatesVideosFragment extends Fragment {
    public static final String TAG = "PartyUpdatesVideosFragment";
    ...
    private void getNewsData() {
       ...
       LinkedHashMap<String, String> paramMap = new LinkedHashMap<>();
        ...
        //    LinearLayout child = (LinearLayout) getActivity().getLayoutInflater().inflate(R.layout.news_home_page_item, null);
            ...
            ImageView img_video = (ImageView) child.findViewById(R.id.img_video);
