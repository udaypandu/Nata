 ...
 */
public class AskForHelpMyModerateListFragment extends Fragment implements IAsyncCaller, View.OnClickListener, AbsListView.OnScrollListener,
        IUpdateNewData {

    public static final String TAG = "AskForHelpMyModerateListFragment";
    ...
    private void getPublicForums(String pageNo) {
        ...
        ServerIntractorAsync serverIntractorAsync = new ServerIntractorAsync(getActivity(), Utility.getResourcesString(getActivity(),
                ...
                APIConstants.ASK_HELPS_LIST_FOR_MODERATERS + id + "/" + pageNo + "/20"
                , paramMap,
    ...
    public void onClick(View view) {
        ...
        bundle.putString(Constants.POST_FROM, name);
        bundle.putString(Constants.POST_IMAGE, img_url);
        Utility.navigateDashBoardFragment(new AskForHelpMyModeratePostForumFragment(), AskForHelpMyModeratePostForumFragment.TAG, bundle, mParent);
    }
