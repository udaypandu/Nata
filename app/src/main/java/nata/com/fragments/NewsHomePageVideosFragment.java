...
public class NewsHomePageVideosFragment extends Fragment implements IAsyncCaller {
    public static final String TAG = "NewsHomePageVideosFragment";
    ...
    private NewsRecycleVideoAdapter newsListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //mParent.getSupportActionBar().setTitle(Utility.getResourcesString(getActivity(), R.string.latest_news).toUpperCase());
        if (rootView != null) {
            return rootView;
        }
    ...
    private void setDataToList() {
        ...
        newsListAdapter = new NewsRecycleVideoAdapter(mParent, mNewsModelsList, TAG);
