...
public class PopularOurForumAdapter extends BaseAdapter {
    private DashboardActivity mContext;
    private LayoutInflater mLayoutInflater;
    private ArrayList<ForumModel> forumModels;
    private Typeface typefaceLatoRegular;

    public PopularOurForumAdapter(DashboardActivity context, ArrayList<ForumModel> forumModels) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PopularOurForumAdapter.PopularOurForumAdapterHolder mPopularOurForumAdapterHolder = null;

        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.ourforum_grid_item,
                    null);
            mPopularOurForumAdapterHolder = new PopularOurForumAdapter.PopularOurForumAdapterHolder();
            ...
            mPopularOurForumAdapterHolder = (PopularOurForumAdapter.PopularOurForumAdapterHolder) convertView.getTag();
        }
